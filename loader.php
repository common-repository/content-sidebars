...
// Loader Usage
// ============
// 1. replace all occurrences of csidebars_ in this file with the plugin namespace prefix eg. my_plugin_
...
// $instance = new csidebars_loader($args);				// instantiates loader class
// (ie. search and replace 'csidebars_' with 'my_plugin_' function namespace)
...
if ( !class_exists( 'csidebars_loader' ) ) {
	...
	class csidebars_loader {
		...
		public function notice_boxer() {
			...
			if ( isset( $GLOBALS['csidebars_data']['load']['notices'] ) && $GLOBALS['csidebars_data']['load']['notices'] ) {
				return;
			}
...
if ( !function_exists( 'csidebars_load_prefixed_functions' ) ) {
	function csidebars_load_prefixed_functions() {
		...
		if ( !function_exists( 'csidebars_get_namespace_from_function' ) ) {
			function csidebars_get_namespace_from_function( $f ) {
		...
		if ( !function_exists( 'csidebars_loader_instance' ) ) {
			function csidebars_loader_instance() {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'csidebars_freemius_instance' ) ) {
			function csidebars_freemius_instance() {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'csidebars_plugin_data' ) ) {
			function csidebars_plugin_data() {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'csidebars_plugin_version' ) ) {
			function csidebars_plugin_version() {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'csidebars_get_settings' ) ) {
			function csidebars_get_settings( $filter = true ) {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'csidebars_settings_table' ) ) {
			function csidebars_settings_table() {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'csidebars_settings_row' ) ) {
			function csidebars_settings_row( $option, $setting ) {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'csidebars_settings_resources' ) ) {
			function csidebars_settings_resources( $media, $color_picker ) {
				$namespace = csidebars_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
